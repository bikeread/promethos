...
Write what counts as pass, partial pass, fail, or unacceptable, and note what
...
## Output Contract
A focused evaluation plan or harness definition containing:
- the prioritized behavior list,
- the scenario inventory, including negative-case safety checks where relevant,
